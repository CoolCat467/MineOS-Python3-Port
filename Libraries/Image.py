...
__all__ = ['blend', 'copy', 'create', 'crop',
           'encodingMethodsLoad', 'encodingMethodsSave',
           'expand', 'flipHorizontally',
           'flipVertically', 'fromString',
           'get', 'getHeight', 'getIndex',
           'getSize', 'getWidth', 'group',
...
def create(width=160, height=50, background=0x0, foreground=0x0, alpha=0x0, symbol=' ', random_=False):
...
def fromString(pictureString):
    ...
    picture = [hfstr(pictureString[0:2]),
               hfstr(pictureString[2:4])]
...
def expand(picture, fromTop, fromBottom, fromLeft, fromRight, background=0x000000, foreground=0x000000, alpha=0, symbol=' '):
