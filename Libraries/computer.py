...
__all__ = ['HZ', 'addUser', 'address', 'beep', 'crash', 'energy', 'freeMemory', 'getArchitecture', 'getBootAddress', 'getDeviceInfo', 'isRobot', 'isRunning', 'math', 'maxEnergy', 'pullSignal', 'pushSignal', 'removeUser', 'runlevel', 'setBootAddress', 'shutdown', 'start', 'stop', 'tmpAddress', 'totalMemory', 'uptime', 'users']
...
def beep(frequency, duration):
    ...
    def play(filename):
        ...
        os.system('ffplay -autoexit -showmode 0 -f f32le -ar %f %s' % (_SAMPLERATE, filename))
